...
Asumimos que los alumnos al no incluir las demás materias en la lista, su preferencia por ellas es cero.
...
En las siguientes gráfica mostramos la frecuencia y la preferencia total de todas las materias registradas:
...
Se extrae el Top 3 de materias de cada grupo encontrado basado en su preferencia total:
